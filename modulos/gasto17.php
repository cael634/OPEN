...
$semanax = date('W',  mktime(0,0,0,$mesx,$diax,$aniox));  
  if(is_uploaded_file($_FILES['imagen']['tmp_name'])){
    ...
    move_uploaded_file($_FILES['imagen']['tmp_name'], "../productos/".$imagen);
  	...
  	$mysqli->query("UPDATE pedido7 SET distribuidor = '$distribuidor',fecha='$fecha',fecha2='$fecha2',semana='$semanax', valor='$valor' WHERE id = '$ide'");
...
?>
                                           ...
                                           <form method="post" action="" enctype="multipart/form-data">
                                            <div class="form-row">
                                                  <div class="form-group">
                                                        <label for="checkout-country">Distribuidor</label>
                                                      </div>
                                                  <div class="form-group" style="
    width: 100%;
    display: flex;">
                                              
                                               <select name="distribuidor" class="form-control form-control-select2">
                                                 <option value="">Proveedor</option>
                                                   <?php
                                                   $qs = $mysqli->query("SELECT * FROM proveedor WHERE id_cliente='$id_cliente'");
    ...
    width: 101%!important;" name="enviar1" type="submit" class="btn btn-primary">
                                                    <a style="    font-size: 13px;" href="?p=distribuidor">Añadir proveedor</a>
                                                </button>
                                                ...
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <input type="number" class="form-control" name="valor" placeholder=" <?=$ro1['valor']?>">
                                                </div>
                                                <div class="form-group">
              <label >Foto de la factura (opcional)</label>
               <input style="font-size: 12px;" type="file" class="form-control" name="imagen" title="Imagen del producto" placeholder="Logo de la empresa"/>
               </div>
                <div class="form-group col-md-6">
                                                    <label for="checkout-first-name">Fecha de entrega</label>
                                                     	<input type="date" name="fecha2" value="<?=$ro1['fecha2']?>"   class="form-control">
                                                </div>
               <div class="form-group col-md-6">
                                                    <label for="checkout-first-name">Fecha de pago</label>
                                                     	<input type="date"name="fecha" value="<?=$ro1['fecha']?>"   class="form-control">
                                                </div>
