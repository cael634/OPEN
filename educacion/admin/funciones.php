...
$user_mysql = "u863656637_open";
$username = "u863656637_open";
$password = "AVjftqxR1@Ds";
$mysqli = mysqli_connect('localhost','u863656637_open','AVjftqxR1@Ds','u863656637_open');
$connection = mysqli_connect('localhost','u863656637_open','AVjftqxR1@Ds','u863656637_open');
function clear($var){
...
function connect(){
	...
	$pass_mysql = "";
	$db_mysql = "open";
 $mysqli = mysqli_connect('localhost','u863656637_open',';[=WgZ5s','u863656637_open');
	return $mysqli;
...
<?php
		...
		?><span class="badge badge-info" style="background: #e2013b;">Esta por llegar</span>
		<?php
	}else{
