...
<style type="text/css">
    ...
    padding-bottom: 0px!important;
        ...
        <!-- site__body -->
        <div class="site__body" style="min-height: 550px!important;">
...
$q = $mysqli->query("SELECT * FROM productos WHERE id_categoria = '$id' AND id_vendedor = '$id_vendedor'");
                                ...
                                <div class="products-view__pagination">
                                    <ul class="pagination justify-content-center">
                                        ...
                                        <li class="page-item disabled">
                                            ...
                                            ?>
                                             <lo style="font-size: 18px"> No se encontro productos de esta categoria en su municipio.</lo>
                                           <?php
                                            }
                                        }
?>
...
if(!isset($_SESSION['id_cliente']) && !isset($muni) ){
    $contador43=0;
$q = $mysqli->query("SELECT * FROM productos WHERE id_categoria = '$id'");
while($r=mysqli_fetch_array($q)){
                                ...
                                <div class="products-view__pagination">
                                    <ul class="pagination justify-content-center">
                                        ...
                                        <li class="page-item disabled">
                                            ...
                                            ?>
                                             <lo style="font-size: 18px">  No se encontro productos en esta categoria.</lo>
                                           <?php
                                            }
                                        }
                                ...
                                <div class="products-view__pagination">
                                    <ul class="pagination justify-content-center">
                                        ...
                                        <li class="page-item disabled">
                                            ...
                                            ?>
                                             <lo style="font-size: 18px"> No se encontro productos de esta categoria en este municipio.</lo>
                                           <?php
                                            }
                                        }
                                ...
                                <div class="products-view__pagination">
                                    <ul class="pagination justify-content-center">
                                        ...
                                        <li class="page-item disabled">
                                            ...
                                            ?>
                                             <lo style="font-size: 18px"> No se encontro productos de esta categoria en este departamento.</lo>
                                           <?php
                                            }
                                        }
