...
<!-- partial -->
  <script src='https://use.fontawesome.com/00a8c63b3c.js'></script>
...
<script async src="https://www.googletagmanager.com/gtag/js?id=G-BJK6400D0M"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'G-BJK6400D0M');
</script>
...
if(!isset($p)){
     ...
     if(isset($_SESSION['id_cliente'])){
         $todogasto=0;
  $s113 = $mysqli->query("SELECT * FROM clientes  WHERE id = '$id_cliente'"); 
  $r113 = mysqli_fetch_array($s113);
   if($r113['gastos']==2){
       // redir("?p=horario");
       redir("?p=proveedoreszon"); 
   }else{
                    ...
                    <div class="container" style="max-width: 1250px!important;">
                        <div class="mobile-header__body">
                            ...
                            <?php
                              ...
                              <?php
 if(isset($_SESSION['id_cliente'])){
  $s113 = $mysqli->query("SELECT * FROM clientes  WHERE id = '".$_SESSION['id_cliente']."'"); 
  $r113 = mysqli_fetch_array($s113);
                           if($r113['gastos']==2){
                               ?>
                            <a class="mobile-header__logo" href="?p=horario">    <img src="estudiar.png" style="width: 40px;">&nbsp; Mi Horario
                               <?php
                             
                           }if($r113['gastos']==0){
                               ?>   
                         <a class="mobile-header__logo" href="?p=proveedoreszon">  <img src="open.png" style="width: 80px;">
                            <!-- logo / end -->
                            <?php
                           }  
                           if($r113['gastos']==1){
                               ?>   
                      <a class="mobile-header__logo" href="?p=gasto">   <img src="analisis.png" style="width: 40px;">
Administra tu tienda       
     ...
     if(isset($horario)){
                               ?>
                                <img src="estudiar.png" style="width: 40px;">&nbsp; Mi Horario
                               <?php
                           }else{
                                if(isset($id)){
                               ?>   
                           <img src="analisis.png" style="width: 40px;">
Administra tu tienda
                            <!-- logo / end -->
                            <?php
}else{
    ?>   
                           <img src="open.png" style="width: 80px;">
                            <!-- logo / end -->
                            <?php
}
}
                            ...
                            <div class="search search--location--mobile-header mobile-header__search">
                                <div class="search__body">
                                    <form class="search__form" method="post"  action="">
                                        ...
                                        <input class="search__input" name="busq"   placeholder="Buscar productos..." aria-label="Site search" type="text" autocomplete="off" style="color:black">
                                ...
                                <div class="indicator indicator--mobile-search indicator--mobile d-md-none" style="    padding: 0px 0px 0px 30%!important;">
...
<?php
  ...
  $id_cliente = $_SESSION['id_cliente'];
  $contador9=0;
  $q5 = $mysqli->query("SELECT * FROM notificacion WHERE id_cliente = '$id_cliente' AND estado=1");
...
?>
                                ...
                                <div class="indicator indicator--mobile">
                                 <!--   <a href="?p=notificacion&act=1" class="indicator__button">-->
                                 <a href="" class="indicator__button">
                                        <span class="indicator__area">
                                             <i class="far fa-bell"></i>
                                            <span class="indicator__value"><?=$contador9?></span>
                                        </span>
                                    </a>
                                </div>
                     <?php
  ...
  $s113 = $mysqli->query("SELECT * FROM clientes  WHERE id = '".$_SESSION['id_cliente']."'"); 
  $r113 = mysqli_fetch_array($s113);
                           if($r113['gastos']>0){}else{
                               ?>                              <div class="indicator indicator--mobile">
                                   <a href="?p=carrito" class="indicator__button">
                                        <span class="indicator__area">
  ...
  $contador ++;
                                            ...
                                            ?>
                                                <span class="indicator__value"><?=$contador?></span>
                                            </span>
    ...
    color: #fff;
        ...
        <header class="site__header d-lg-block d-none">
            <div class="site-header" style ="background-color:#e2013b;">
                <!-- .topbar -->
 ...
 if(isset($_SESSION['id_cliente'])){
  ...
  $r113 = mysqli_fetch_array($s113);
                           if($r113['gastos']==2){
                               ?>
                              <a href="?p=horario">   <img src="estudiar.png" style="width: 55px;">&nbsp; <af style="color:white">Mi Horario</af>
                               <?php
                             
                           }if($r113['gastos']==0){
                               ?>   
                           <a href="?p=proveedoreszon"> <img src="open.png" style="width: 85px;">
                            <!-- logo / end -->
                            <?php
                           }  
                           if($r113['gastos']==1){
                               ?>   
                         <a href="?p=gasto"> <img src="analisis.png" style="width: 55px;">   
Administra tu tienda    
                               <?php
     ...
     if(isset($horario)){
                               ?>
                                <img src="estudiar.png" style="width: 55px;"><a1 style="color:white">&nbsp;Mi Horario</a1>
                               <?php
                           }else{
                                if(isset($id)){
                               ?>   
                           <img src="analisis.png" style="width: 55px;">
<a1 style="color:white">Administra tu tienda</a1>
                            <!-- logo / end -->
                            <?php
}else{
    ?>   
                           <img src="open.png" style="width: 85px;">
                            <!-- logo / end -->
                            <?php
}
}
    ...
    height: 65px!important;
                    ...
                    <div class="site-header__search">
                        <div class="search search--location--header ">
                            <div class="search__body">
                                <form class="search__form" method="post"  action="">
                                    <input type="text" class="search__input" name="busq" placeholder="Buscar productos..." aria-label="Site search" type="text" autocomplete="off">
                                    <button class="search__button search__button--type--submit" type="submit">
                                        <i class="fas fa-search" style="color: #585353"></i>
                                    </button>
                                    <div class="search__border"></div>
                                </form>
...
.plan {
    ...
    border: 1px solid #7b6c6c!important;
    ...
    text-align: center!important;
                    ...
                    <div class="site-header__phone">
                        <div class="site-header__phone-title" style="color:#e2013b;">Atención al cliente</div>
                                            ...
                                            <div class="departments__links-wrapper">
                                                ...
                                                <ul class="departments__links">
                                                    <li class="departments__item">
                                                        ...
                                                        <a class="departments__item-link" href="?p=categoriasver&id=1">
                                                            Despensa
                                                    ...
                                                    <li class="departments__item">
                                                        <a class="departments__item-link" href="?p=categoriasver&id=2">
                                                            Abarrotes
                                                    ...
                                                    <li class="departments__item">
                                                        <a class="departments__item-link" href="?p=categoriasver&id=3">
                                                            Pasabocas salados
                                                    ...
                                                    <li class="departments__item">
                                                       <a class="departments__item-link" href="?p=categoriasver&id=4">
                                                        Verduras frescas
                                                        </a>
                                                    </li>
                                                    <li class="departments__item">
                                                       <a class="departments__item-link" href="?p=categoriasver&id=5">
                                                        Frutas Frescas
                                                        </a>
                                                    </li>
                                                   
                                                    <li class="departments__item">
                                                       <a class="departments__item-link" href="?p=categoriasver&id=6">
                                                           Golosinas
                                                    ...
                                                    <li class="departments__item">
                                                       <a class="departments__item-link" href="?p=categoriasver&id=7">
                                                           Bebidas
                                                        </a>
                                                    </li>
                                                    <li class="departments__item">
                                                       <a class="departments__item-link" href="?p=categoriasver&id=8">
                                                           Carnes
                                                        </a>
                                                    </li>
                                                    <li class="departments__item">
                                                       <a class="departments__item-link" href="?p=categoriasver&id=9">
                                                           Aseo hogar
                                                        </a>
                                                    </li>
                                                    <li class="departments__item">
                                                       <a class="departments__item-link" href="?p=categoriasver&id=10">
                                                        Aseo personla
                                                        </a>
                                                    </li>
                                                    <li class="departments__item">
                                                       <a class="departments__item-link" href="?p=categoriasver&id=11">
                                                        Productos para bebes
                                                        </a>
                                                    </li>
                                                    <li class="departments__item">
                                                       <a class="departments__item-link" href="?p=categoriasver&id=12">
                                                        Mascotas
                                                        </a>
                                                    </li>
                                ...
                                <div class="nav-panel__nav-links nav-links">
                                    <ul class="nav-links__list">
                                        <li class="nav-links__item  nav-links__item--has-submenu ">
                                            <a class="nav-links__item-link" href="?p=productos">
    ...
    font-family: 'Raleway', sans-serif!important;
                                        ...
                                        <li class="nav-links__item  nav-links__item--has-submenu ">
                                            <a class="nav-links__item-link" href="?p=ofertas">
                                                <div class="nav-links__item-body">
                                                    Ofertas &nbsp;
                                                    ...
                                                    <div class="megamenu__body">
                                                        <div class="row">
                                                                ...
                                                                <ul class="megamenu__links megamenu__links--level--0">
                                                                    <li class="megamenu__item  megamenu__item--with-submenu ">
                                                                        ...
                                                                        <ul class="megamenu__links megamenu__links--level--1">
                                                                            <li class="megamenu__item"><a href="?p=ofertascat&id=1">Despensa</a></li>
                                                                            <li class="megamenu__item"><a href="?p=ofertascat&id=2">Abarrotes</a></li>
                                                                            <li class="megamenu__item"><a href="?p=ofertascat&id=3">Verduras frescas</a></li>
                                                                            <li class="megamenu__item"><a href="?p=ofertascat&id=4">Frutas frescas</a></li>
                                                                            <li class="megamenu__item"><a href="?p=ofertascat&id=5">Pasabocas salados</a></li>
                                                                            <li class="megamenu__item"><a href="?p=ofertascat&id=6">Golosinas</a></li>
                                                                            <li class="megamenu__item"><a href="?p=ofertascat&id=7">Bebidas</a></li>
                                                                            <li class="megamenu__item"><a href="?p=ofertascat&id=8">Carnes</a></li>
                                                                            <li class="megamenu__item"><a href="?p=ofertascat&id=13">Frutas y verduras</a></li>
                                                            ...
                                                            <div class="col-6">
                                                                <ul class="megamenu__links megamenu__links--level--0">
                                                                    <li class="megamenu__item  megamenu__item--with-submenu ">
                                                                        <a href="">Utensilios y mas</a>
                                                                        <ul class="megamenu__links megamenu__links--level--1">
                                                                           <li class="megamenu__item"><a href="?p=ofertascat&id=10">Aseo personal</a></li>
                                                                            <li class="megamenu__item"><a href="?p=ofertascat&id=9">Aseo hogar</a></li>
                                                                            <li class="megamenu__item"><a href="?p=ofertascat&id=11">Productos para bebes</a></li>
                                                                            <li class="megamenu__item"><a href="?p=ofertascat&id=12">Mascotas</a></li>
                                                                        </ul>
                                                                    </li>
                                        ...
                                        <li class="nav-links__item  nav-links__item--has-submenu ">
                                            <a class="nav-links__item-link" href="?p=carrito">
                                                <div class="nav-links__item-body">
                                                    Carrito
                                        ...
                                        <li class="nav-links__item  nav-links__item--has-submenu ">
                                            <a class="nav-links__item-link" href="?p=miscompras">
                                                <div class="nav-links__item-body">
                                                    Mis compras
                                        ...
                                        <li class="nav-links__item ">
                                            <a class="nav-links__item-link" href="info/index.php">
                                                <div class="nav-links__item-body">
                                                    Inicio empresas
                                                </div>
                                            </a>
                                        ...
                                        <div class="indicator__dropdown">
                                            ...
                                            <div class="dropcart dropcart--style--dropdown">
                                                ...
                                                <div class="dropcart__body">
                                                    ...
                                                    <div class="dropcart__products-list" style="    padding: 3px 0px 16px 0px;">
                                                        <div class="dropcart__buttons" style="        padding: 0px 0px 0px 8px;">
                                                    <a  style="max-width: 400px;    padding: 0px 0px 5px 0px;" href="javascript:location.reload()">Marcar como vistas</a>
                                                    </div>
  ...
  ?>
                                                        <div class="dropcart__product">
                                                            <div class="product-image dropcart__product-image">
                                                                <a href="?p=produc&id=<?=$rq['id_producto'];?>"><img src="productos/<?=$rw1['imagen']?>" alt="">
                                                                </a>
                                                            </div>

                                                            <div class="dropcart__product-info">
                                                                <div class="dropcart__product-name"><a href="?p=produc&id=<?=$rq['id_producto'];?>"><?=$rw1['name']?></a></div>
                                                                <ul class="dropcart__product-options">
                                                                    <li><?=$tipo?><br><a style="color:blue" href="?p=vendedor&id=<?=$rq['id_vendedor'];?>">Vendedor: <?=$rw12['name']?></a> </li>
                                                                </ul>
...
$monto_total=0;
     $id_cliente = $_SESSION['id_cliente'];
    $q = $mysqli->query("SELECT * FROM carro WHERE id_cliente = '$id_cliente' AND devolucion=0");
    while($r = mysqli_fetch_array($q)){
  ...
  $q25 = $mysqli->query("SELECT * FROM admins WHERE id = '$id_vendedor'");
  ...
  ?>
                                                        <div class="dropcart__product">
                                                            <div class="product-image dropcart__product-image">
                                                                <a href="?p=produc&id=<?=$r2['id'];?>" class="product-image__body">
                                                                    <img class="product-image__img" src="productos/<?=$imagen_producto?>" alt="">
                                                                </a>
                                                            </div>

                                                            <div class="dropcart__product-info">
                                                                <div class="dropcart__product-name"><a href="?p=produc&id=<?=$r2['id'];?>"><?=$nombre_producto?></a></div>
                                                                <ul class="dropcart__product-options">
                                                                    <li><?=$r25['name']?></li>
                                                                </ul>
        ...
        <span class="dropcart__product-price"><?=$divisa?><?=number_format($r2['price'])?>
                                                                           <?php
    }else{
            ?>
             <div class="dropcart__product-meta">
                                                                    <span class="dropcart__product-quantity">Cantidad: <?=$cantidad?>&nbsp;</span> 
              <span class="dropcart__product-price"><span class="badge badge-info"> Devolución </span>
            <?php
...
<?php
     ...
     $id_cliente = $_SESSION['id_cliente'];
    $q = $mysqli->query("SELECT * FROM carro WHERE id_cliente = '$id_cliente' AND devolucion=1");
    while($r = mysqli_fetch_array($q)){
...
?>
                                                    ...
                                                    <div class="dropcart__totals">
                                                        <table>
                                                            ...
                                                            <tr>
                                                                ...
                                                                if($precio_total==0){
                                                                    ?>
                                                                <th>No has agregado productos al carrito</th>
                                                                <?php
                                                            }else{
                                                            ?>
                                                                <th>Total</th>
                                                                <td><?=$divisa?><?=number_format($monto_total)?></td>
                                                                <?php
                                                            }
                                                            ?>
                                                            </tr>
                                                    ...
                                                    <a class="btn btn-secondary" style="max-width: 400px;" href="?p=carrito">Ver carrito</a>
                                                    </div>
                                                </div>
                                            </div>
                                            <style>
...
if(isset($enviar)){
    ...
    $q = $mysqli->query("SELECT * FROM clientes WHERE username = '$username1' AND password = '$password1'");
    ...
    ?>
                                                    ...
                                                    <form method="post" action="" class="account-menu__form">
                                                    <div class="account-menu__form-title">Ingrese a su cuenta</div>
                                                    <div class="form-group">
                                                        <label for="header-signin-email" class="sr-only">Corre electronico</label>
                                                        <input id="header-signin-email" type="text"  class="form-control form-control-sm" placeholder="Usuario" name="username1">
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="header-signin-password" class="sr-only">Contraseña</label>
                                                        <div class="account-menu__form-forgot">
                                                            <input id="header-signin-password" type="password" class="form-control form-control-sm" placeholder="Contraseña" name="password1">
                                                            
                                                        </div>
                                                    </div>
                                                    <div class="form-group account-menu__form-button">
                                                        <button type="submit" name="enviar" class="btn btn-primary btn-sm">Iniciar sesión</button>
                                                    </div>
                                                    <div class="account-menu__form-link"><a href="?p=registron">Crea una cuenta</a></div>
</form>
  ...
  $sc = $mysqli->query("SELECT * FROM clientes WHERE id = '$id_cliente'");
                                            ...
                                            ?>
                                                ...
                                                <a href="account-dashboard.html" class="account-menu__user">
                                                    ...
                                                    <div class="account-menu__user-info">
                                                        <div class="account-menu__user-name"><?=$rc['name']?></div>
                                                        <div class="account-menu__user-email"><?=$rc['nombrev']?>m</div>
                                                ...
                                                <ul class="account-menu__links">
                                                    ...
                                                    <li><a href="?p=faltantes">Pedidos pendientes</a></li>
                                                    <li><a href="?p=editclient">Configuraciones</a></li>
                                                    <li><a href="?p=gastos">Administa tus gastos</a></li>
                                                    
                                                </ul>
                                                <div class="account-menu__divider"></div>
                                                <ul class="account-menu__links">
                                                    <li><a href="?p=salir">Cerrar sesion</a></li>
                                                </ul>
                                            </div>
                                            <?php
                ...
                <ul class="mobile-links mobile-links--level--0" data-collapse data-collapse-opened-class="mobile-links__item--open">
                    ...
                    <li class="mobile-links__item" data-collapse-item>
                        <div class="mobile-links__item-title">
                            <a  class="mobile-links__item-link"><?=$rc['name']?></a>
                        ...
                        <div class="mobile-links__item-sub-links" data-collapse-content>
                            <ul class="mobile-links mobile-links--level--1">
                                <li class="mobile-links__item" data-collapse-item>
                                    <div class="mobile-links__item-title">
                                        <a href="?p=editclient" class="mobile-links__item-link">Editar información</a>
                                        <button class="mobile-links__item-toggle" type="button" data-collapse-trigger>
                                            <svg class="mobile-links__item-arrow" width="12px" height="7px">
                                                <use xlink:href="images/sprite.svg#arrow-rounded-down-12x7"></use>
                                            </svg>
                                    ...
                                    <div class="mobile-links__item-sub-links" data-collapse-content>
                                        <ul class="mobile-links mobile-links--level--2">
                                            <li class="mobile-links__item" data-collapse-item>
                                                <div class="mobile-links__item-title">
                                                    <a href="?p=logoute" class="mobile-links__item-link">Salir</a>
                                                </div>
                                            </li>
  ...
  $r113 = mysqli_fetch_array($s113);
                    ...
                    <li class="mobile-links__item" data-collapse-item>
                                    <div class="mobile-links__item-title">
                                        <a href="?p=gasto"class="mobile-links__item-link"> Administa tus gastos</a>
                                    </div>
                                </li>
  <li class="mobile-links__item" data-collapse-item>
                                    <div class="mobile-links__item-title">
                                        <a href="?p=faltantes"class="mobile-links__item-link">Pedidos faltantes</a>
                                    </div>
                                </li>
               ...
               <!--
                    <li class="mobile-links__item" data-collapse-item>
                        <div class="mobile-links__item-title">
                            <a class="mobile-links__item-link">Categorias</a>
                            <button class="mobile-links__item-toggle" type="button" data-collapse-trigger>
                                <svg class="mobile-links__item-arrow" width="12px" height="7px">
                                    <use xlink:href="images/sprite.svg#arrow-rounded-down-12x7"></use>
                                </svg>
                        ...
                        <div class="mobile-links__item-sub-links" data-collapse-content>
                            <ul class="mobile-links mobile-links--level--1">
                                <li class="mobile-links__item" data-collapse-item>
                                    <div class="mobile-links__item-title">
                                        <a  class="mobile-links__item-link" href="?p=categoriasver&id=1">Despensa</a>
                                    </div>
                                </li>
                                <li class="mobile-links__item" data-collapse-item>
                                    <div class="mobile-links__item-title">
                                        <a  class="mobile-links__item-link"  href="?p=categoriasver&id=2">Abarrotes</a>
                                    </div>
                                </li>
                                <li class="mobile-links__item" data-collapse-item>
                                    <div class="mobile-links__item-title">
                                        <a  class="mobile-links__item-link"  href="?p=categoriasver&id=3">Pasabocas salados</a>
                                    </div>
                                </li>
                                <li class="mobile-links__item" data-collapse-item>
                                    <div class="mobile-links__item-title">
                                        <a  class="mobile-links__item-link"  href="?p=categoriasver&id=4">Verduras frescas</a>
                                    </div>
                                </li>
                                <li class="mobile-links__item" data-collapse-item>
                                    <div class="mobile-links__item-title">
                                        <a  class="mobile-links__item-link"  href="?p=categoriasver&id=5">Frutas frescas</a>
                                    </div>
                                </li>
                                <li class="mobile-links__item" data-collapse-item>
                                    <div class="mobile-links__item-title">
                                        <a  class="mobile-links__item-link"  href="?p=categoriasver&id=6">Golosinas</a>
                                    </div>
                                </li>
                                <li class="mobile-links__item" data-collapse-item>
                                    <div class="mobile-links__item-title">
                                        <a  class="mobile-links__item-link"  href="?p=categoriasver&id=7">Bebidas</a>
                                    </div>
                                <li class="mobile-links__item" data-collapse-item>
                                    <div class="mobile-links__item-title">
                                        <a  class="mobile-links__item-link"  href="?p=categoriasver&id=8">Carnes</a>
                                    </div>
                                <li class="mobile-links__item" data-collapse-item>
                                    <div class="mobile-links__item-title">
                                        <a  class="mobile-links__item-link"  href="?p=categoriasver&id=9">Aseo hogar</a>
                                    </div>
                                <li class="mobile-links__item" data-collapse-item>
                                    <div class="mobile-links__item-title">
                                        <a class="mobile-links__item-link"  href="?p=categoriasver&id=10">Aseo personal</a>
                                    </div>
                                <li class="mobile-links__item" data-collapse-item>
                                    <div class="mobile-links__item-title">
                                        <a  class="mobile-links__item-link"  href="?p=categoriasver&id=11">Productos para bebes</a>
                                    </div>
                                    <li class="mobile-links__item" data-collapse-item>
                                    <div class="mobile-links__item-title">
                                        <a  class="mobile-links__item-link"  href="?p=categoriasver&id=12">Mascotas</a>
                                    </div>
                    ...
                    <li class="mobile-links__item" data-collapse-item>
                                    <div class="mobile-links__item-title">
                                        <a href="?p=ofertas"class="mobile-links__item-link">Ofertas</a>
                                    </div>
                                </li>
                                -->
                        <div class="mobile-links__item-sub-links" data-collapse-content>
                            <ul class="mobile-links mobile-links--level--1">
                                <li class="mobile-links__item" data-collapse-item>
                                    <div class="mobile-links__item-title">
                                        <a href="?=carrito" class="mobile-links__item-link">Carrito</a>
                                        <button class="mobile-links__item-toggle" type="button" data-collapse-trigger>
                                            <svg class="mobile-links__item-arrow" width="12px" height="7px">
                                                <use xlink:href="images/sprite.svg#arrow-rounded-down-12x7"></use>
                                            </svg>
                                    ...
                                    <div class="mobile-links__item-sub-links" data-collapse-content>
                                        <ul class="mobile-links mobile-links--level--2">
                                            <li class="mobile-links__item" data-collapse-item>
                                                <div class="mobile-links__item-title">
                                                    <a href="?p=miscompras" class="mobile-links__item-link">Mis compras</a>
                                                </div>
                                            </li>
                                            <li class="mobile-links__item" data-collapse-item>
                                                <div class="mobile-links__item-title">
                                                    <a href="shop-grid-4-columns-full.html" class="mobile-links__item-link">Mis cuentas</a>
                                                </div>
                                            </li>
                                            <li class="mobile-links__item" data-collapse-item>
                                                <div class="mobile-links__item-title">
...
<?php
  ...
  $r113 = mysqli_fetch_array($s113);
                     ...
                     ?>
                                <li class="mobile-links__item" data-collapse-item>
                                    <div class="mobile-links__item-title">
                                        <a href="?p=carrito" class="mobile-links__item-link">Carrito</a>
                                    </div>
                                </li>

                                <li class="mobile-links__item" data-collapse-item>
                                    <div class="mobile-links__item-title">
                                        <a href="?p=miscompras" class="mobile-links__item-link">Mis pedidos</a>
                                    </div>
                                </li>
                                <li class="mobile-links__item" data-collapse-item>
                                    <div class="mobile-links__item-title">
                ...
                <li class="mobile-links__item" data-collapse-item>
                                    <div class="mobile-links__item-title">
                                        <a href="?p=registro" class="mobile-links__item-link">Iniciar sesión</a>
                                    </div>
                                </li>
                                <li class="mobile-links__item" data-collapse-item>
                                    <div class="mobile-links__item-title">
                                        <a href="?p=registron" class="mobile-links__item-link">Registro</a>
                                    </div>
                                </li>
                                      <?php
                }
...
.capa-degradado {
    ...
    height: 100%;
    position: absolute;
    background: -webkit-linear-gradient(left, #191919, #C2000B);
    opacity: 0.5;
}
...
/****************************************
    Submenu Quienes Somos Responsive
****************************************/
.contenedor-submenu-quienes-somos-responsive {
    right: -100%;
    top: 60px;
    position: absolute;
    background: #191919;
...
.contenedor-submenu-quienes-somos-responsive.active {
    right: 0;
    opacity: 1;
}

.contenedor-submenu-quienes-somos-responsive a {
    padding: 20px;
    color: #fff;
    display: block;
    border: 2px solid #191919;
...
.contenedor-submenu-quienes-somos-responsive a:hover {
    border: 2px solid #fff;
}
