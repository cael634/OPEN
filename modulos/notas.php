                                ...
                                <div class="card-body">
                                    <div class="row no-gutters">
                                        <div class="col-12 col-lg-10 col-xl-8">
                                            ...
                                            <div class="form-row">
                                                <?php
$sq = $mysqli->query("SELECT * FROM materia WHERE id_cliente = '$id_cliente'  ");
$contador198 = 0;
  ...
  <div class="card border-left-success shadow h-100 py-2" style="box-shadow: none!important;border: 1px solid #bbbbc3;    width: -webkit-fill-available;">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                       <div class="text-xs font-weight-bold text-success text-uppercase mb-1"style="font-size:15px"><a href="?p=calificaciones&ide=<?=$rq['id']?>"><?=$rq['nombrem']?></a></div>
                      <div class="h5 mb-0 font-weight-bold text-gray-800" style=" font-size:15px;   width: 203px;">Tipo: <a href="<?=$rq['tipo']?>" style="font-size:15px"><?=$rq['tipo']?></a></div>
