...
if(isset($enviar)){
    ...
    $empresa= clear($empresa);
        ...
        $mysqli->query("INSERT INTO admins (departamento,municipio,entrega,direccion,name,empresa,tipo) VALUES ('$select4','$select5','$entrega','$direccion','$name','$empresa','$tipo')");
       
       
    if ($entrega==1) {
        redir("lugar.php?id=$name"); 
                # code...
            } else{
                  redir("user.php?id=$name"); 
            }       
           # code...      
}
?>
        ...
        <header class="site__header d-lg-block d-none">
            <div class="site-header">
                ...
                <div class="site-header__middle container">
                  <img src="open.png" style="width: 100px;"><div class="site-header__phone-number">&nbsp;&nbsp;&nbsp;&nbsp;Registro empresa</div>
                  </div>  
                  <style type="text/css">
    .site-header {
    position: relative;
...
.site-header__middle {
    ...
    height: 80px !important;
        ...
        <div class="site__body" style="padding-left: 100px;
    padding-top: 0px;">
                                        ...
                                        <div class="col-12 col-lg-10 col-xl-8">
                                         ...
                                         $qn = $mysqli->query("SELECT * FROM municipios  ");
                                          ...
                                          <?php
                                            ...
                                            <div class="form-group">
                                                <label for="checkout-country">Cantidad de puntos de distribución</label>
                                              
                                                 <select  name="entrega" id="select1" class="form-control form-control-select2">
                                                   <option value="">Cantidad de puntos de distribución</option>   
                                                   <option value="1">Solo un punto</option>   
                                                   <option value="2">Mas de un puntos de distribución</option>    
                                                </select>
                                            </div>
                                            ...
                                            <div class="form-group mt-3 mb-0">
                                                <button  name="enviar" href="lugar.php" type="submit" class="btn btn-primary">Siguiente</button>
                                            </div>
                                        </form>
                                        </div>
                                    </div>
