...
$q = $mysqli->query("SELECT * FROM productos WHERE name like '%$busq%' AND id_vendedor = '$id_vendedor'");
...
?>
         <div class="view-options view-options--offcanvas--always">
                                        ...
                                        <div class="view-options__legend" style="padding: 0px 0px 7px;">Mostrando <?=$contador43?> de <?=$contador43?> productos</div>
...
while($ryy=mysqli_fetch_array($syy)){
      $id_vendedor=$ryy['id_vendedor'];
$q = $mysqli->query("SELECT * FROM admins WHERE name like '%$busq%' AND id = '$id_vendedor'");
while($r=mysqli_fetch_array($q)){
      ...
      <div class="products-list__item">
                                            <div class="product-card product-card--hidden-actions ">
                                                ...
                                                <div class="product-card__info">
                                                   ...
                                                   <center><a href="?p=produc&id=<?=$r['id'];?>"><?=$r['name']?></a></center>     
                                                    </div>
                                                                                                                                                                 <?php
...
$ro = mysqli_fetch_array($so);
            ?>
                                          <center>     <div class="product__rating">
                                  
                                    
                                  <a style="font-size:13px;" href="?p=vendedor&id=<?=$ro['id'];?>">Ver productos</a>
...
<?php
$q12 = $mysqli->query("SELECT * FROM admins WHERE name like '%$busq%' ");
...
?>
      ...
      <div class="products-list__item">
                                            <div class="product-card product-card--hidden-actions ">
                                                ...
                                                <div class="product-card__image product-image">
                                                    <a href="?p=produc&id=<?=$r['id'];?>" class="product-image__body">
                                                        ...
                                                        if($r12['imagen']!=0){
                                                        ?>
                                                        <img class="product-image__img" src="admin/productos/<?=$r12['imagen']?>"  alt="">
                                                        <?php
                                                        }else{
                                                            ?>
                                                            <img class="product-image__img" src="interfaz.png"  alt="" style="width: 104%; height: 80%;">
                                ...
                                <?php
                                                ...
                                                <div class="product-card__info">
                                                    <div class="product-card__name">
                                                   <center><a href="?p=produc&id=<?=$r['id'];?>"><?=$r12['name']?></a></center>     
                                                    </div>
                                                                                                                                                                 <?php
            
            $so = $mysqli->query("SELECT * FROM admins WHERE id = '".$r12['id']."'");
$ro = mysqli_fetch_array($so);
            ?>
                                          <center>     <div class="product__rating">
...
?> 
         <div class="view-options view-options--offcanvas--always">
                                        ...
                                        <div class="view-options__legend" style="padding: 0px 0px 7px;">Mostrando <?=$contador43?> de <?=$contador43?> productos</div><br>
                                        <div class="view-options__divider"></div>
                                        <div class="view-options__control">
                                ...
                                <div class="products-view__list products-list" data-layout="grid-5-full" data-with-features="false" data-mobile-grid-columns="2">
                                    <div class="products-list__body">
                                        <?php
$syy3 = $mysqli->query("SELECT * FROM cobertura WHERE municipio = '$muni'");
while($ryy3=mysqli_fetch_array($syy3)){
      $id_vendedor=$ryy3['id_vendedor'];
$q12 = $mysqli->query("SELECT * FROM admins WHERE name like '%$busq%' AND id = '$id_vendedor' ");
while($r12=mysqli_fetch_array($q12)){
?>
...
?> 
         <div class="view-options view-options--offcanvas--always">
                                ...
                                <div class="products-view__list products-list" data-layout="grid-5-full" data-with-features="false" data-mobile-grid-columns="2">
                                    <div class="products-list__body">
<?php
$syy1 = $mysqli->query("SELECT * FROM cobertura WHERE departamento = '$dep'");
while($ryy1=mysqli_fetch_array($syy1)){
      $id_vendedor=$ryy1['id_vendedor'];
$q12 = $mysqli->query("SELECT * FROM admins WHERE name like '%$busq%' AND id= '$id_vendedor'");
while($r12=mysqli_fetch_array($q12)){
?>
