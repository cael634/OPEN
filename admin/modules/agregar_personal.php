...
if(isset($enviar)){
  ...
  $id_vendedor = $_SESSION['id_vendedor'];
    ...
    $mysqli->query("INSERT INTO seguimiento (name,password,username,id_vendedor) VALUES ('$nombre','$password1','$username1','$id_vendedor')");
                                        ...
                                        <div class="col-12 col-lg-10 col-xl-8">
                                            <form method="post" action="">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="username1" placeholder="Usuario">
                                                </div>
