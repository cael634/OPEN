...
$semanax = date('W',  mktime(0,0,0,$mesx,$diax,$aniox));  
  ...
  $mysqli->query("INSERT INTO pedido7 (descripcion,tipo,fecha,foto,valor,id_cliente,tipoid,semana) VALUES ('$descripcion','$tipo','$fecha','$imagen','$valor','$id_cliente',5,'$semanax')");
                            ...
                            <div class="account-nav flex-grow-1" style="    max-height: 350px;">
                                ...
                                <ul>
                                    ...
                                    <li class="account-nav__item  account-nav__item--active ">
                                        <a href="?p=registron">Otros gastos</a>
                                    </li>
                                           ...
                                           <form method="post" action="" enctype="multipart/form-data">
                                            <div class="form-row">
                                                  <div class="form-group col-md-6">
                                                    <label for="checkout-first-name">Tipo de gasto</label>
                                                    <input type="text" name="tipo" class="form-control" name="nombrev" placeholder="(Arriendo)">
                                                </div>
                                                <div class="form-group col-md-6">
                                                    <label for="checkout-first-name">Descripción</label>
                                                    <input type="text" class="form-control" name="descripcion" placeholder="(Arriendo Marzo)">
                                                </div>
                                                <div class="form-group col-md-6">
                                                    <label for="checkout-first-name">Valor del gasto</label>
                                                    <input type="text" class="form-control" name="valor" placeholder="Valor del gasto">
                                                </div>
