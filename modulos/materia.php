...
$semanax = date('W',  mktime(0,0,0,$mesx,$diax,$aniox));  
  ...
  $mysqli->query("INSERT INTO materia (id_cliente,nombrep,nombrem,contacto,tipo) VALUES ('$id_cliente','$nombrep','$nombrem','$contacto','$tipo')");

    alert("Se agrego la materia",1,'horario');
}
                                           ...
                                           <form method="post" action="" enctype="multipart/form-data">
                                            <div class="form-row">
                                                  <div class="form-group col-md-6">
                                                    <label for="checkout-first-name">Nombre de la Materia</label>
                                                    <input type="text" name="nombrem" class="form-control" name="nombrem" placeholder="Materia">
                                                </div>
                                                  <div class="form-group">
                                                <label for="checkout-country">Tipo de materia</label>
                                              
                                                 <select  name="tipo" id="tipo" class="form-control form-control-select2">
                                                 
                                                
                                                <option value="Teorica">Teorica</option> 
                                                <option value="Practica">Practica</option> 
                                                <option value="Teorica y practica">Teorica y practica</option>  
                                                
                                                </select>
                                            </div>
                                                <div class="form-group col-md-6">
                                                    <label for="checkout-first-name">Nombre del profesor</label>
                                                    <input type="text" class="form-control" name="nombrep" placeholder="Nombre">
                                                </div>
                                                <div class="form-group col-md-6">
                                                    <label for="checkout-first-name">Contacto del profesor (opcional)</label>
