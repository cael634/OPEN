...
if(isset($enviar1)){
	$mysqli->query("UPDATE seguimiento SET name = '$name',username = '$username', password = '$password' WHERE id = '$id' ");		
...
?>
  ...
  <div class="col-12 col-lg-9 mt-4 mt-lg-0">
                 ...
                 <input type="text" class="form-control" name="username" value="<?=$re['username']?>">
                                                </div>

                             <div class="form-group">
                                                    <label for="checkout-first-name">Contraseña</label>
                                          <input type="text" class="form-control" name="password" value="<?=$re['password']?>">
                                                </div>
     <div class="form-group">
