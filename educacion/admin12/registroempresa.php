...
if(isset($enviar)){
    ...
    $empresa= clear($empresa);
        ...
        $mysqli->query("INSERT INTO admins (departamento,municipio,direccion,name,empresa) VALUES ('$select4','$select5','$direccion','$name','$empresa')");
       
  $sc1 = $mysqli->query("SELECT * FROM admins  ORDER BY id DESC LIMIT 1");
  $rc1 = mysqli_fetch_array($sc1);
  $idea=$rc1['id'];

        redir("user.php?id=$idea"); 
                # code...
        ...
        <header class="site__header d-lg-block d-none">
            <div class="site-header">
                ...
                <div class="site-header__middle container">
                  <img src="open (2).png" style="width: 140px;"><div class="site-header__phone-number">&nbsp;&nbsp;&nbsp;&nbsp;Registro empresa</div>
                  </div>  
                  <style type="text/css">
    .site-header {
    position: relative;
                                        ...
                                        <div class="col-12 col-lg-10 col-xl-8">
                                            <form method="post" action="">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="name" placeholder="Nombre de la empresa" required="required">
                                                </div>

                                                <div class="form-group">
                                                <label for="checkout-country">Tipo de empresa</label>
                                              
                                                 <select  name="empresa" id="select1" class="form-control form-control-select2" required="required">
                                            ...
                                            <div class="form-group">
                                                <label for="checkout-country">Pais</label>
                                                 ...
                                                 <select  name="select4" id="select4" class="form-control form-control-select2" required="required">
                                                 <option value="">Pais</option>
                                                 <?php
                                                 $qn = $mysqli->query("SELECT * FROM paises  ");
                                            ...
                                            <div class="form-group">
                                                    <label for="checkout-first-name">Ciudad</label>
                                                    <input type="text" class="form-control" name="select5" placeholder="Ciudad" required="required">
                                                </div>
                                            


                                             <div class="form-group">
                                                    <label for="checkout-first-name">Direccion</label>
                                            ...
                                            <div class="form-group mt-3 mb-0">
                                                <button  name="enviar" href="user.php" type="submit" class="btn btn-primary">Siguiente</button>
                                            </div>
                                        </form>
                                        </div>
                                    </div>
