                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Horario</li>
                                   <a href="?p=materia">  <input type="submit" class="btn btn-primary" name="Despachado" value="Nueva Materia" style="
                ...
                <div class="container">
                    <div class="row">
                            ...
                            <div class="account-nav flex-grow-1" style="    max-height: 350px;">
                                ...
                                <ul>
                                    ...
                                    ?>
                                        ...
                                        <a href="?p=horario1&id=1">Lunes</a>
                                    </li>
                                    <?php
                                    if($id==2){
                                      ?>
                                    ...
                                    ?>
                                        ...
                                        <a href="?p=horario1&id=2">Martes</a>
                                    </li>
                                    <?php
                                    if($id==3){
                                      ?>
                                    ...
                                    ?>
                                        ...
                                        <a href="?p=horario1&id=3">Miercoles</a>
                                    </li>
                                    <?php
                                    if($id==4){
                                      ?>
                                    ...
                                    ?>
                                        ...
                                        <a href="?p=horario1&id=4">Jueves</a>
                                    </li>
                                    <?php
                                    if($id==5){
                                      ?>
                                    ...
                                    ?>
                                        ...
                                        <a href="?p=horario1&id=5">Viernes</a>
                                    </li>
                                    <?php
                                    if($id==6){
                                      ?>
                                    ...
                                    ?>
                                        ...
                                        <a href="?p=horario1&id=6">Sabado</a>
                                    </li>
                                    <?php
                                    if($id==7){
                                      ?>
                                    ...
                                    ?>
                                        ...
                                        <a href="?p=horario1&id=7">Domingo</a>
                                    </li>
                        ...
                        <div class="col-12 col-lg-9 mt-4 mt-lg-0">
                          <a href="?p=diamateria">  <input type="submit" class="btn btn-primary" name="Despachado" value="Agregar materia al dia" style="
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters">
                                        <div class="col-12 col-lg-10 col-xl-8">
                                            ...
                                            <div class="form-row">
                                                <?php
$sq = $mysqli->query("SELECT * FROM diamateria WHERE id_cliente = '$id_cliente' AND diama = '$id' ");
$contador198 = 0;
while($rq=mysqli_fetch_array($sq)){
  $q2 = $mysqli->query("SELECT * FROM materia WHERE id = '".$rq['materia']."'");
  $r2 = mysqli_fetch_array($q2);
$contador198++;
$s22 = "SELECT TIME_FORMAT('".$rq['time1']."', '%h:%i %p') AS f22";
$res22= $mysqli->query($s22);
$data22=mysqli_fetch_array($res22);

$s21 = "SELECT TIME_FORMAT('".$rq['time2']."', '%h:%i %p') AS f21";
  ...
  <div class="card border-left-success shadow h-100 py-2" style="box-shadow: none!important;border: 1px solid #bbbbc3;    width: -webkit-fill-available;">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                       <div class="text-xs font-weight-bold text-success text-uppercase mb-1"style="font-size:15px"><?=$r2['nombrem']?></div>
                      <div class="h5 mb-0 font-weight-bold text-gray-800" style=" font-size:15px;   width: 203px;">Link: <a href="<?=$rq['link']?>" style="font-size:15px"><?=$rq['link']?></a></div>
                     
                    </div>
                    <div class="col-auto" style="width:70px">
                        <?=$data22['f22']?> <?=$data21['f21']?>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div class="card border-left-success shadow h-100 py-2" style="box-shadow: none!important;border: 1px solid #bbbbc3;    width: -webkit-fill-available;">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                       <div class="text-xs font-weight-bold text-success text-uppercase mb-1"style="font-size:15px; text-align: center;">No has agregado ni una materia a este día</div><br>
                      <div class="h5 mb-0 font-weight-bold text-gray-800" style=" font-size:15px;   text-align: center;   "><a href="?p=diamateria" >Agregar materia</a> </div>
