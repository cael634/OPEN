...
$semanax = date('W',  mktime(0,0,0,$mesx,$diax,$aniox));  
	...
	$mysqli->query("UPDATE pedido7 SET descripcion = '$descripcion',tipo='$tipo',fecha='$fecha',semana='$semanax', valor='$valor' WHERE id = '$ide'");
  redir("?p=gasto");
}
                                           ...
                                           <form method="post" action="" enctype="multipart/form-data">
                                            <div class="form-row">
                                                  <div class="form-group col-md-6">
                                                    ...
                                                    <input type="text" name="tipo" class="form-control" name="nombrev" placeholder="<?=$ro1['tipo']?>">
                                                </div>
                                                <div class="form-group col-md-6">
                                                ...
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <input type="text" class="form-control" name="valor" placeholder="<?=number_format($ro1['valor'])?>">
                                                </div>
...
$(function () {
 ...
 <a href="productos/<?=$ro1['foto']?>" class="zoom"><img src="productos/<?=$ro1['foto']?>" style="    width: auto;
    height: auto;
    max-width: -webkit-fill-available;" /></a><br><br>
               <div class="form-group col-md-6">
