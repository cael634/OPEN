...
if(isset($enviar)){
 ...
 if(is_uploaded_file($_FILES['imagen']['tmp_name'])){
    ...
    $mysqli->query("UPDATE admins SET username = '$username',password = '$password',emp = '$emp',ter = '$ter', imagen = '$imagen'  WHERE name='$id'");

   $mysqli->query("INSERT INTO admins (id,imagen) VALUES (1000,'$imagen')");
  ...
  ?>
              ...
              <label>Logo de la empresa</label>
               <input type="file" class="form-control" name="imagen" title="Imagen del producto" placeholder="Logo de la empresa"/>
                                        ...
                                        <?php
$qn = $mysqli->query("SELECT * FROM admins WHERE name = '$id'  ");
$rl=mysqli_fetch_array($qn);
if ($rl['tipo']==2 && $rl['entrega']==1 ) {
       
                    ?>

Horario de distribución:<br><br>
<div class="time">
De <input type="time" name="emp"> hasta <input type="time" name="ter">
</div>
 <?php
                }
            ?>
                ...
                <div class="container">
                    <div class="site-footer__widgets">
                        <div class="row">
                            ...
                            <div class="col-6 col-md-3 col-lg-2">
                                <div class="site-footer__widget footer-links">
                                    <h5 class="footer-links__title">Cobertura</h5>
                                    <ul class="footer-links__list">
