...
$semanax = date('W',  mktime(0,0,0,$mesx,$diax,$aniox));  
  ...
  $mysqli->query("INSERT INTO pedido7 (distribuidor,fecha,fecha2,foto,valor,id_cliente,semana,tipoid) VALUES ('$distribuidor','$fecha1','$fecha2','$imagen','$valor','$id_cliente','$semanax',7)");
...
?>
    ...
    width: 101%!important;" name="enviar1" type="submit" class="btn btn-primary">
                                                    <a style="color:white;    font-size: 13px;" href="?p=distribuidor">Añadir Proveedor</a>
                                                </button>
                                        
                                            </div>
                                                <div class="form-group col-md-6">
                                                    <label for="checkout-first-name">Valor del pago</label>
                                                    <input type="number" class="form-control" name="valor" placeholder="Valor del pago">
                                                </div>
                                                <div class="form-group">
