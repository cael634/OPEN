...
$semanax = date('W',  mktime(0,0,0,$mesx,$diax,$aniox));  
  ...
  $mysqli->query("INSERT INTO pedido7 (descripcion,fecha,foto,valor,id_cliente,tipoid,semana) VALUES ('$descripcion','$fecha','$imagen','$valor','$id_cliente',6,'$semanax')");
                                          ...
                                          <form method="post" action="" enctype="multipart/form-data">
                                            <div class="form-row">
                                                ...
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <input type="text" class="form-control" name="descripcion" placeholder="(Servicio de electricidad)">
                                                </div>
                                                <div class="form-group col-md-6">
