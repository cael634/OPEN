...
if(isset($eliminar)){
  ...
  $mysqli->query("DELETE FROM pedido7 WHERE id = '$eliminar'");
      alert("Gasto eliminado",1,'todogast5');
}
...
?>
    ...
    display: contents;
">                                    
         <a style="padding:5px">Organiza y administra tus demas gastos</a> 
         <br><br>
...
?>
            ...
            <td style="text-align: center;"><?=$r24['tipo']?></td>       
            ...
            <td style="text-align: center;">$ <?=number_format($r24['valor'])?></td>
             <td style="text-align: center;"><a href="?p=gasto15&ide=<?=$r24['id']?>"><i class="fas fa-question-circle"></i></a></td>
           <td style="text-align: center;"><a href="?p=todogast5&eliminar=<?=$r24['id']?>"><i class="fas fa-times-circle"></i></a></td>
