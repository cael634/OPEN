    ...
    max-width: 100%;">
              ...
              <div class="card shadow mb-4">
                <div class="card-header py-3">
                  <h6 class="m-0 font-weight-bold text-primary">Ventas <?=$diar?></h6>
                </div>
                <div class="card-body">
                  <?php
                  $mes = date('m');
...
?>
    ...
    max-width: 100%;">
              ...
              <div class="card shadow mb-4">
                <div class="card-header py-3">
                  <h6 class="m-0 font-weight-bold text-primary">Ventas <?=$mesro?> del <?=$anior?></h6>
                </div>
                <div class="card-body">
<?php
...
?>
 ...
 <div class="row">
    ...
    max-width: 100%;">
              ...
              <div class="card shadow mb-4">
                <div class="card-header py-3">
                  <h6 class="m-0 font-weight-bold text-primary">Ventas de <?=$primerDia?> hasta <?=$ultimoDia?>.
                   Semana <?=$semanau?> </h6>
                </div>
                <div class="card-body">
<?php
...
<?php
  ...
  ?>
    ...
    max-width: 100%;">
              ...
              <div class="card shadow mb-4">
                <div class="card-header py-3">
                  <h6 class="m-0 font-weight-bold text-primary">Porcentaje de ventas este mes</h6>
                </div>
                <div class="card-body">
                  <?php
                  $mes = date('m');
