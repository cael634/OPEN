...
?>
                  <form class="user">
                    ...
                    <div class="form-group">
                     ...
                     <center> <button  name="logear" type="submit" class="btn btn-primary btn-user btn-block" style="    max-width:400px;padding: 0px;" style="width: 200px;">Iniciar</button></center>
                    <hr>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow" style="box-shadow: 0 .15rem 1.75rem 0 rgba(255, 255, 255, 0)!important">
          ...
          <center style="padding: 8px;">Bienvenido, si quieres asesoramiento o tiene preguntas contactanos al correo: cael04311@gmail.com </center>
